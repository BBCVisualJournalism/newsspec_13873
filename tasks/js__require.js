module.exports = function (grunt) {
    ...
    var _ = require('lodash-node'),
        requirePathsForJquery1build = _.merge({'jquery': './lib/vendors/jquery/jquery-1.11.4'}, amdModulePaths),
        requirePathsForJquery2build = _.merge({'jquery': './lib/vendors/jquery/jquery-2.1.5'}, amdModulePaths),
        requireJsDefaults = {
            options: {
                baseUrl: './source/js',
                optimize: 'uglify2',
